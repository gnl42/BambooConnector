...
@JsonPropertyOrder({
  ...
  ImmutableResultsSummary.JSON_PROPERTY_LABELLINGS,
...
public class ImmutableResultsSummary implements Serializable {
  ...
  **/
  ...
  public ImmutableResultsSummary labellings(List<Labelling> labellings) {
    this.labellings = labellings;
    return this;
  }

  public ImmutableResultsSummary addLabellingsItem(Labelling labellingsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.planKey, immutableResultsSummary.planKey) &&
        ...
        Objects.equals(this.labellings, immutableResultsSummary.labellings) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(planKey, planResultKey, repositoryChangesets, immutablePlan, planName, successful, failed, notRunYet, notBuilt, labelNames, lifeCycleState, inProgress, pending, labellings, subscriptions, planIfExists, immutableChain, triggerReason, deltaState, onceOff, customBuild, rebuild, logSize, processingDuration, buildCancelledDate, buildCompletedDate, finished, waiting, customBuildData, jiraIssues, fixingJiraIssues, relatedJiraIssues, jiraIssueKeys, uniqueAuthors, timeToFix, testResultsSummary, durationDescription, processingDurationDescription, shortReasonSummary, reasonSummary, relativeBuildDate, relativeQueueDate, relativeBuildStartedDate, testSummary, buildTime, queueTime, artifactLinks, artifactLinksThatExist, changesListSummary, substitutedVariables, variableContextLogs, manuallyOverriddenVariables, restartCount, commits, buildAgentId, buildAgentType, fullPlanName, duration, active, queued, id, statDate, buildDate, buildState, buildNumber);
  }
