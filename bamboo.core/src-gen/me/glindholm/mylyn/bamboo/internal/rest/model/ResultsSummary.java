...
@JsonPropertyOrder({
  ...
  ResultsSummary.JSON_PROPERTY_LABELLINGS,
...
public class ResultsSummary implements Serializable {
  ...
  **/
  ...
  public ResultsSummary labellings(List<Labelling> labellings) {
    this.labellings = labellings;
    return this;
  }

  public ResultsSummary addLabellingsItem(Labelling labellingsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.buildKey, resultsSummary.buildKey) &&
        ...
        Objects.equals(this.labellings, resultsSummary.labellings) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(buildKey, buildResultKey, immutablePlan, duration, triggerReason, deltaState, onceOff, customBuild, rebuild, logSize, processingDuration, buildCompletedDate, buildCancelledDate, timeToFix, testResultsSummary, buildDate, queueTime, restartCount, buildAgentId, buildAgentType, variableContextBaselineId, formatVersion, variableContextLogsEncrypted, substitutedVariablesEncrypted, id, markedForDeletion, planKey, planResultKey, repositoryChangesets, planName, successful, failed, notRunYet, notBuilt, labelNames, lifeCycleState, inProgress, pending, labellings, subscriptions, planIfExists, immutableChain, finished, waiting, customBuildData, jiraIssues, fixingJiraIssues, relatedJiraIssues, jiraIssueKeys, uniqueAuthors, durationDescription, processingDurationDescription, shortReasonSummary, reasonSummary, relativeBuildDate, relativeQueueDate, relativeBuildStartedDate, testSummary, buildTime, artifactLinks, artifactLinksThatExist, changesListSummary, substitutedVariables, variableContextLogs, manuallyOverriddenVariables, commits, fullPlanName, active, queued, statDate, buildState, buildNumber);
  }
