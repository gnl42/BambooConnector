...
public class RestEnvironment implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, key, name, description, deploymentProjectId, operations, position, configurationState, triggerDefinitions, suspended, requirementSet, taskDefinitionsSupplier, triggerDefinitionsSupplier, taskDefinitions);
  }
