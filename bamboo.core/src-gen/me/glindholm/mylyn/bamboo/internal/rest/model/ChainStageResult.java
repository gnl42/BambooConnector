...
import me.glindholm.mylyn.bamboo.internal.rest.model.StageVariableContext;
...
public class ChainStageResult implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.restartable, chainStageResult.restartable) &&
        ...
        Objects.equals(this.chainResult, chainStageResult.chainResult) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(restartable, successful, failed, notBuilt, lifeCycleState, pending, processingDuration, finished, manual, chainResult, buildResults, sortedBuildResults, failedBuildResults, successfulBuildResults, allJobsExist, allNotSuccessfulJobsExist, _final, runnable, manualVariables, manualVariablesEncrypted, completed, state, id, name, description);
  }
