...
import me.glindholm.mylyn.bamboo.internal.rest.model.Label;
...
public class Labelling implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(plan, label, creationDate, buildResultsSummary, lastModificationDate, project, userName, id);
  }
