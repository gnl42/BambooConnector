...
public class DirectoryInformationResult implements Serializable {
  ...
  private Object buildLogJobRoots;
  ...
  **/
  ...
  public DirectoryInformationResult buildLogJobRoots(Object buildLogJobRoots) {
  ...
  **/
  ...
  public Object getBuildLogJobRoots() {
    return buildLogJobRoots;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BUILD_LOG_JOB_ROOTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBuildLogJobRoots(Object buildLogJobRoots) {
    this.buildLogJobRoots = buildLogJobRoots;
  }
