...
public class ImmutablePlan implements Serializable {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.variables, immutablePlan.variables) &&
        Objects.equals(this.markedForDeletion, immutablePlan.markedForDeletion) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(variables, markedForDeletion, latestResultsSummary, executing, busy, labelNames, buildDefinition, currentStatus, buildLogger, firstBuildNumber, lastBuildNumber, averageBuildDuration, effectiveVariables, key, type, active, master, project, buildName, buildKey, planKey, planType, suspendedFromBuilding, databaseId, masterId, masterIdIfExists, name, id, description, entityType, oid);
  }
