...
import me.glindholm.mylyn.bamboo.internal.rest.model.RestQueuedDeployments;
import me.glindholm.mylyn.bamboo.internal.rest.model.VersionPreview;
...
public class DeploymentApi {
   ...
   */
  public RestQueuedDeployments getBuildQueue(String expand) throws ApiException {
    ApiResponse<RestQueuedDeployments> localVarResponse = getBuildQueueWithHttpInfo(expand);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestQueuedDeployments> getBuildQueueWithHttpInfo(String expand) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBuildQueueRequestBuilder(expand);
    try {
  ...
  private HttpRequest.Builder getBuildQueueRequestBuilder(String expand) throws ApiException {
