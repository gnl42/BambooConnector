...
@JsonPropertyOrder({
  ...
  ChainResultsSummary.JSON_PROPERTY_ORDERED_JOB_RESULT_SUMMARIES,
  ChainResultsSummary.JSON_PROPERTY_PLAN_KEY,
  ChainResultsSummary.JSON_PROPERTY_PLAN_RESULT_KEY,
  ChainResultsSummary.JSON_PROPERTY_REPOSITORY_CHANGESETS,
  ...
  ChainResultsSummary.JSON_PROPERTY_LABELLINGS,
...
public class ChainResultsSummary implements Serializable {
  ...
  public static final String JSON_PROPERTY_ORDERED_JOB_RESULT_SUMMARIES = "orderedJobResultSummaries";
  private List<ResultsSummary> orderedJobResultSummaries;
  ...
  **/
  ...
  public ChainResultsSummary orderedJobResultSummaries(List<ResultsSummary> orderedJobResultSummaries) {
    this.orderedJobResultSummaries = orderedJobResultSummaries;
    return this;
  }

  public ChainResultsSummary addOrderedJobResultSummariesItem(ResultsSummary orderedJobResultSummariesItem) {
    if (this.orderedJobResultSummaries == null) {
      this.orderedJobResultSummaries = new ArrayList<>();
    }
    this.orderedJobResultSummaries.add(orderedJobResultSummariesItem);
    return this;
  }

   /**
   * Get orderedJobResultSummaries
   * @return orderedJobResultSummaries
  **/
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "")
  @JsonProperty(JSON_PROPERTY_ORDERED_JOB_RESULT_SUMMARIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_ORDERED_JOB_RESULT_SUMMARIES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrderedJobResultSummaries(List<ResultsSummary> orderedJobResultSummaries) {
    this.orderedJobResultSummaries = orderedJobResultSummaries;
  }
  ...
  **/
  ...
  public ChainResultsSummary repositoryChangesets(List<RepositoryChangeset> repositoryChangesets) {
    this.repositoryChangesets = repositoryChangesets;
    return this;
  }

  public ChainResultsSummary addRepositoryChangesetsItem(RepositoryChangeset repositoryChangesetsItem) {
  ...
  **/
  ...
  public ChainResultsSummary labellings(List<Labelling> labellings) {
    this.labellings = labellings;
    return this;
  }

  public ChainResultsSummary addLabellingsItem(Labelling labellingsItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.specsResult, chainResultsSummary.specsResult) &&
        ...
        Objects.equals(this.fixedInResult, chainResultsSummary.fixedInResult) &&
        ...
        Objects.equals(this.orderedJobResultSummaries, chainResultsSummary.orderedJobResultSummaries) &&
        ...
        Objects.equals(this.repositoryChangesets, chainResultsSummary.repositoryChangesets) &&
        ...
        Objects.equals(this.labellings, chainResultsSummary.labellings) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(specsResult, mergeResult, continuable, fixedInResult, restartable, immutablePlan, planIfExists, stageResults, testResults, failedJobResults, totalJobCount, orderedJobResultSummaries, planKey, planResultKey, repositoryChangesets, planName, successful, failed, notRunYet, notBuilt, labelNames, lifeCycleState, inProgress, pending, labellings, immutableChain, triggerReason, deltaState, onceOff, customBuild, rebuild, logSize, processingDuration, buildCancelledDate, buildCompletedDate, finished, waiting, customBuildData, jiraIssues, fixingJiraIssues, relatedJiraIssues, jiraIssueKeys, uniqueAuthors, timeToFix, testResultsSummary, durationDescription, processingDurationDescription, shortReasonSummary, reasonSummary, relativeBuildDate, relativeQueueDate, relativeBuildStartedDate, testSummary, buildTime, queueTime, artifactLinks, artifactLinksThatExist, changesListSummary, substitutedVariables, variableContextLogs, manuallyOverriddenVariables, restartCount, commits, buildAgentId, buildAgentType, fullPlanName, duration, active, queued, id, statDate, buildDate, buildState, buildNumber, buildKey, buildResultKey, variableContextBaselineId, formatVersion, variableContextLogsEncrypted, substitutedVariablesEncrypted, markedForDeletion);
  }
  ...
  public String toString() {
    ...
    sb.append("    orderedJobResultSummaries: ").append(toIndentedString(orderedJobResultSummaries)).append("\n");
