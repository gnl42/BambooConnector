...
import me.glindholm.mylyn.bamboo.internal.rest.model.GetEphemeralAgentPodRawLogs200Response;
...
public class DefaultApi {
   ...
   * @param online Filter agents based on their online statuses (optional)
   ...
   * @param maxResults Maximum size for returned list (optional)
   ...
   * @throws ApiException if fails to make API call
   */
  public RestResults getBranchHistory(String buildKey, String branchName, String projectKey, Boolean includeAllStates, Boolean continuable, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String expand, String lifeCycleState) throws ApiException {
    ApiResponse<RestResults> localVarResponse = getBranchHistoryWithHttpInfo(buildKey, branchName, projectKey, includeAllStates, continuable, issueKey, maxResults, startIndex, label, buildstate, favourite, expand, lifeCycleState);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestResults> getBranchHistoryWithHttpInfo(String buildKey, String branchName, String projectKey, Boolean includeAllStates, Boolean continuable, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String expand, String lifeCycleState) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBranchHistoryRequestBuilder(buildKey, branchName, projectKey, includeAllStates, continuable, issueKey, maxResults, startIndex, label, buildstate, favourite, expand, lifeCycleState);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getBranchHistoryRequestBuilder(String buildKey, String branchName, String projectKey, Boolean includeAllStates, Boolean continuable, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String expand, String lifeCycleState) throws ApiException {
    ...
    localVarQueryParameterBaseName = "max-results";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("max-results", maxResults));
    localVarQueryParameterBaseName = "start-index";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("start-index", startIndex));
   ...
   * @throws ApiException if fails to make API call
   */
  public RestResultsResults getBuildHistory(String projectKey, String buildKey, Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    ApiResponse<RestResultsResults> localVarResponse = getBuildHistoryWithHttpInfo(projectKey, buildKey, includeAllStates, continuable, expand, issueKey, maxResults, startIndex, label, buildstate, favourite, lifeCycleState);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestResultsResults> getBuildHistoryWithHttpInfo(String projectKey, String buildKey, Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBuildHistoryRequestBuilder(projectKey, buildKey, includeAllStates, continuable, expand, issueKey, maxResults, startIndex, label, buildstate, favourite, lifeCycleState);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getBuildHistoryRequestBuilder(String projectKey, String buildKey, Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    // verify the required parameter 'projectKey' is set
    if (projectKey == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RestQueuedBuilds getBuildQueue1(String expand, Integer maxResult, Integer startIndex) throws ApiException {
    ApiResponse<RestQueuedBuilds> localVarResponse = getBuildQueue1WithHttpInfo(expand, maxResult, startIndex);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestQueuedBuilds> getBuildQueue1WithHttpInfo(String expand, Integer maxResult, Integer startIndex) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getBuildQueue1RequestBuilder(expand, maxResult, startIndex);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getBuildQueue1", localVarResponse);
        }
  ...
  private HttpRequest.Builder getBuildQueue1RequestBuilder(String expand, Integer maxResult, Integer startIndex) throws ApiException {
   ...
   * @param pod Pod name (required)
   * @param containerName Container name, by default empty (optional)
   * @return GetEphemeralAgentPodRawLogs200Response
   * @throws ApiException if fails to make API call
   */
  public GetEphemeralAgentPodRawLogs200Response getEphemeralAgentPodRawLogs(String pod, String containerName) throws ApiException {
    ApiResponse<GetEphemeralAgentPodRawLogs200Response> localVarResponse = getEphemeralAgentPodRawLogsWithHttpInfo(pod, containerName);
    return localVarResponse.getData();
  }
   ...
   * @param pod Pod name (required)
   * @param containerName Container name, by default empty (optional)
   * @return ApiResponse&lt;GetEphemeralAgentPodRawLogs200Response&gt;
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<GetEphemeralAgentPodRawLogs200Response> getEphemeralAgentPodRawLogsWithHttpInfo(String pod, String containerName) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getEphemeralAgentPodRawLogsRequestBuilder(pod, containerName);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("getEphemeralAgentPodRawLogs", localVarResponse);
        }
        return new ApiResponse<GetEphemeralAgentPodRawLogs200Response>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<GetEphemeralAgentPodRawLogs200Response>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder getEphemeralAgentPodRawLogsRequestBuilder(String pod, String containerName) throws ApiException {
    // verify the required parameter 'pod' is set
    if (pod == null) {
      throw new ApiException(400, "Missing the required parameter 'pod' when calling getEphemeralAgentPodRawLogs");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/api/latest/ephemeral/pod/{pod}/logs/raw"
        .replace("{pod}", ApiClient.urlEncode(pod.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public RestResultsResults getLatestBuildResults(Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    ApiResponse<RestResultsResults> localVarResponse = getLatestBuildResultsWithHttpInfo(includeAllStates, continuable, expand, issueKey, maxResults, startIndex, label, buildstate, favourite, lifeCycleState);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestResultsResults> getLatestBuildResultsWithHttpInfo(Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getLatestBuildResultsRequestBuilder(includeAllStates, continuable, expand, issueKey, maxResults, startIndex, label, buildstate, favourite, lifeCycleState);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getLatestBuildResultsRequestBuilder(Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public RestResultsResults getLatestBuildResultsForProject(String projectKey, Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    ApiResponse<RestResultsResults> localVarResponse = getLatestBuildResultsForProjectWithHttpInfo(projectKey, includeAllStates, continuable, expand, issueKey, maxResults, startIndex, label, buildstate, favourite, lifeCycleState);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<RestResultsResults> getLatestBuildResultsForProjectWithHttpInfo(String projectKey, Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getLatestBuildResultsForProjectRequestBuilder(projectKey, includeAllStates, continuable, expand, issueKey, maxResults, startIndex, label, buildstate, favourite, lifeCycleState);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder getLatestBuildResultsForProjectRequestBuilder(String projectKey, Boolean includeAllStates, Boolean continuable, String expand, String issueKey, Integer maxResults, Integer startIndex, String label, String buildstate, String favourite, String lifeCycleState) throws ApiException {
    // verify the required parameter 'projectKey' is set
    if (projectKey == null) {
   ...
   * @param online Filter remote agents based on their online statuses (optional)
   * @return List&lt;RestBuildAgent&gt;
   * @throws ApiException if fails to make API call
   */
   ...
   * @throws ApiException if fails to make API call
   */
  public RestUserDarkFeature put(String userName, String key, RestDarkFeature restDarkFeature) throws ApiException {
    ApiResponse<RestUserDarkFeature> localVarResponse = putWithHttpInfo(userName, key, restDarkFeature);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestUserDarkFeature> putWithHttpInfo(String userName, String key, RestDarkFeature restDarkFeature) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = putRequestBuilder(userName, key, restDarkFeature);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder putRequestBuilder(String userName, String key, RestDarkFeature restDarkFeature) throws ApiException {
    // verify the required parameter 'userName' is set
    if (userName == null) {
      throw new ApiException(400, "Missing the required parameter 'userName' when calling put");
    }
    // verify the required parameter 'key' is set
    if (key == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public RestDarkFeature put1(String key, RestDarkFeature restDarkFeature) throws ApiException {
    ApiResponse<RestDarkFeature> localVarResponse = put1WithHttpInfo(key, restDarkFeature);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<RestDarkFeature> put1WithHttpInfo(String key, RestDarkFeature restDarkFeature) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = put1RequestBuilder(key, restDarkFeature);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder put1RequestBuilder(String key, RestDarkFeature restDarkFeature) throws ApiException {
    // verify the required parameter 'key' is set
    if (key == null) {
   ...
   * @throws ApiException if fails to make API call
   */
  public void triggerSpecsScanning(String name, Long repositoryId, Long id, String repositoryName) throws ApiException {
    triggerSpecsScanningWithHttpInfo(name, repositoryId, id, repositoryName);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> triggerSpecsScanningWithHttpInfo(String name, Long repositoryId, Long id, String repositoryName) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = triggerSpecsScanningRequestBuilder(name, repositoryId, id, repositoryName);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder triggerSpecsScanningRequestBuilder(String name, Long repositoryId, Long id, String repositoryName) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public void triggerSpecsScanning1(Long repositoryId, String branch) throws ApiException {
    triggerSpecsScanning1WithHttpInfo(repositoryId, branch);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Void> triggerSpecsScanning1WithHttpInfo(Long repositoryId, String branch) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = triggerSpecsScanning1RequestBuilder(repositoryId, branch);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder triggerSpecsScanning1RequestBuilder(Long repositoryId, String branch) throws ApiException {
    // verify the required parameter 'repositoryId' is set
    if (repositoryId == null) {
      throw new ApiException(400, "Missing the required parameter 'repositoryId' when calling triggerSpecsScanning1");
    }
