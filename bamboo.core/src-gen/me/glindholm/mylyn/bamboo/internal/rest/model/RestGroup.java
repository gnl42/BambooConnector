 ...
 */
@JsonPropertyOrder({
  RestGroup.JSON_PROPERTY_SELF,
  RestGroup.JSON_PROPERTY_NAME,
  RestGroup.JSON_PROPERTY_EDITABLE
})
...
public class RestGroup implements Serializable {
  ...
  **/
  ...
  public RestGroup name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this RestGroup object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    RestGroup restGroup = (RestGroup) o;
    return Objects.equals(this.self, restGroup.self) &&
        Objects.equals(this.name, restGroup.name) &&
        Objects.equals(this.editable, restGroup.editable);
  }

  @Override
  public int hashCode() {
    return Objects.hash(self, name, editable);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RestGroup {\n");
