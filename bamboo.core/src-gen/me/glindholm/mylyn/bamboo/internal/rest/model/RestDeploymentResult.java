...
public class RestDeploymentResult implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(deploymentVersion, deploymentVersionName, id, deploymentState, lifeCycleState, startedDate, queuedDate, executedDate, finishedDate, reasonSummary, key, agent, operations, environment, agentType, environmentId, agentId, triggerReason, customData);
  }
