...
@JsonPropertyOrder({
  ...
  RestElasticConfiguration.JSON_PROPERTY_UPLOAD_AWS_ACCOUNT_IDENTIFIER_TO_ELASTIC_INSTANCES,
...
public class RestElasticConfiguration implements Serializable {
  ...
  public static final String JSON_PROPERTY_UPLOAD_AWS_ACCOUNT_IDENTIFIER_TO_ELASTIC_INSTANCES = "uploadAwsAccountIdentifierToElasticInstances";
  private Boolean uploadAwsAccountIdentifierToElasticInstances;
  ...
  **/
  ...
  public RestElasticConfiguration uploadAwsAccountIdentifierToElasticInstances(Boolean uploadAwsAccountIdentifierToElasticInstances) {
    this.uploadAwsAccountIdentifierToElasticInstances = uploadAwsAccountIdentifierToElasticInstances;
    return this;
  }

   /**
   * Get uploadAwsAccountIdentifierToElasticInstances
   * @return uploadAwsAccountIdentifierToElasticInstances
  **/
  @jakarta.annotation.Nullable
  @Schema(requiredMode = Schema.RequiredMode.NOT_REQUIRED, description = "")
  @JsonProperty(JSON_PROPERTY_UPLOAD_AWS_ACCOUNT_IDENTIFIER_TO_ELASTIC_INSTANCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public Boolean getUploadAwsAccountIdentifierToElasticInstances() {
    return uploadAwsAccountIdentifierToElasticInstances;
  }
  ...
  @JsonProperty(JSON_PROPERTY_UPLOAD_AWS_ACCOUNT_IDENTIFIER_TO_ELASTIC_INSTANCES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setUploadAwsAccountIdentifierToElasticInstances(Boolean uploadAwsAccountIdentifierToElasticInstances) {
    this.uploadAwsAccountIdentifierToElasticInstances = uploadAwsAccountIdentifierToElasticInstances;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, restElasticConfiguration.self) &&
        ...
        Objects.equals(this.uploadAwsAccountIdentifierToElasticInstances, restElasticConfiguration.uploadAwsAccountIdentifierToElasticInstances) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(self, enabled, awsCredentialsType, accessKeyId, secretAccessKey, region, privateKeyFile, certificateFile, uploadAwsAccountIdentifierToElasticInstances, maxNumOfElasticInstances, allocatePublicIpToVpcInstances, elasticInstanceManagement, elasticTerminationConfiguration);
  }
  ...
  public String toString() {
    ...
    sb.append("    uploadAwsAccountIdentifierToElasticInstances: ").append(toIndentedString(uploadAwsAccountIdentifierToElasticInstances)).append("\n");
