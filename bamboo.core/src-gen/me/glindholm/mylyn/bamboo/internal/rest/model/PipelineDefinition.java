...
import me.glindholm.mylyn.bamboo.internal.rest.model.ResultKey;
...
public class PipelineDefinition implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dedicated, creationDate, lastModificationDate, ephemeralAgentDedicationUntyped, ephemeralAgentDedication, name, type, enabled, description, id);
  }
