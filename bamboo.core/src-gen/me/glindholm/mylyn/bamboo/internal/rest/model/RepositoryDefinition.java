...
public class RepositoryDefinition implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(markedForDeletion, entityType, global, webRepositoryPluginKey, webRepositoryViewer, _configuration, repository, id, name, description, newRepositoryInstance, oid, pluginKey, position);
  }
