...
import me.glindholm.mylyn.bamboo.internal.rest.model.ImmutableArtifactSubscription;
...
public class ImmutableJob implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(requirementSet, entityType, artifactSubscriptions, effectiveRequirementSet, divergent, artifactDefinitions, parent, master, stage, variables, markedForDeletion, latestResultsSummary, executing, busy, labelNames, buildDefinition, currentStatus, buildLogger, firstBuildNumber, lastBuildNumber, averageBuildDuration, effectiveVariables, key, type, active, project, buildName, buildKey, planKey, planType, suspendedFromBuilding, databaseId, masterId, masterIdIfExists, name, id, description, oid, taskDefinitions);
  }
