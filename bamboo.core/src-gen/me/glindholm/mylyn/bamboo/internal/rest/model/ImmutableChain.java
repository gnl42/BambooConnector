...
public class ImmutableChain implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(notificationSet, allJobs, hashCodeNullable(storageTag), vcsBambooSpecsSource, entityType, stages, allStages, jobCount, effectiveRepositoryDefinitions, planRepositoryDefinitions, lastResultKey, creationDate, master, variables, markedForDeletion, latestResultsSummary, executing, busy, labelNames, buildDefinition, currentStatus, buildLogger, firstBuildNumber, lastBuildNumber, averageBuildDuration, effectiveVariables, key, type, active, project, buildName, buildKey, planKey, planType, suspendedFromBuilding, databaseId, masterId, masterIdIfExists, name, id, description, oid, triggerDefinitions, suspended);
  }
