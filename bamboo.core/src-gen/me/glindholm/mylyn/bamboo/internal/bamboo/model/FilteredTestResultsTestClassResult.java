...
import me.glindholm.mylyn.bamboo.internal.bamboo.model.TestCaseResult;
 ...
 */
@JsonPropertyOrder({
  FilteredTestResultsTestClassResult.JSON_PROPERTY_FIXED_TESTS,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_SKIPPED_TESTS,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_NEW_FAILED_TESTS,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_EXISTING_FAILED_TESTS,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_ALL_FAILED_TESTS,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_QUARANTINED_TESTS,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_ALL_FAILED_TEST_LIST,
  FilteredTestResultsTestClassResult.JSON_PROPERTY_SKIPPED_TEST_LIST
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2023-08-08T20:39:31.812169500-07:00[America/Vancouver]")
public class FilteredTestResultsTestClassResult implements Serializable {
  ...
  public FilteredTestResultsTestClassResult() { 
  }

  public FilteredTestResultsTestClassResult fixedTests(Object fixedTests) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult skippedTests(Object skippedTests) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult newFailedTests(Object newFailedTests) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult existingFailedTests(Object existingFailedTests) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult allFailedTests(Object allFailedTests) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult quarantinedTests(Object quarantinedTests) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult allFailedTestList(List<TestCaseResult> allFailedTestList) {
    this.allFailedTestList = allFailedTestList;
    return this;
  }

  public FilteredTestResultsTestClassResult addAllFailedTestListItem(TestCaseResult allFailedTestListItem) {
  ...
  **/
  ...
  public FilteredTestResultsTestClassResult skippedTestList(List<TestCaseResult> skippedTestList) {
    this.skippedTestList = skippedTestList;
    return this;
  }

  public FilteredTestResultsTestClassResult addSkippedTestListItem(TestCaseResult skippedTestListItem) {
  ...
  **/
  ...
  /**
   * Return true if this FilteredTestResultsTestClassResult object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    FilteredTestResultsTestClassResult filteredTestResultsTestClassResult = (FilteredTestResultsTestClassResult) o;
    return equalsNullable(this.fixedTests, filteredTestResultsTestClassResult.fixedTests) &&
        equalsNullable(this.skippedTests, filteredTestResultsTestClassResult.skippedTests) &&
        equalsNullable(this.newFailedTests, filteredTestResultsTestClassResult.newFailedTests) &&
        equalsNullable(this.existingFailedTests, filteredTestResultsTestClassResult.existingFailedTests) &&
        equalsNullable(this.allFailedTests, filteredTestResultsTestClassResult.allFailedTests) &&
        equalsNullable(this.quarantinedTests, filteredTestResultsTestClassResult.quarantinedTests) &&
        Objects.equals(this.allFailedTestList, filteredTestResultsTestClassResult.allFailedTestList) &&
        Objects.equals(this.skippedTestList, filteredTestResultsTestClassResult.skippedTestList);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(fixedTests), hashCodeNullable(skippedTests), hashCodeNullable(newFailedTests), hashCodeNullable(existingFailedTests), hashCodeNullable(allFailedTests), hashCodeNullable(quarantinedTests), allFailedTestList, skippedTestList);
  }
  ...
  public String toString() {
    ...
    sb.append("class FilteredTestResultsTestClassResult {\n");
