...
public class BranchMonitoringConfiguration implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(planBranchWorkflow, planBranchCreationEnabled, removedBranchCleanUpEnabled, inactiveBranchCleanUpEnabled, matchingPattern, inactiveBranchCleanUpPeriodInDays, removedBranchCleanUpPeriodInDays, defaultBranchNotificationStrategy, defaultBranchIntegrationConfiguration, remoteJiraBranchLinkingEnabled, branchTriggeringOption, defaultTrigger, valid);
  }
