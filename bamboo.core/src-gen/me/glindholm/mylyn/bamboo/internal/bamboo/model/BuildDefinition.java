...
import me.glindholm.mylyn.bamboo.internal.bamboo.model.BranchIntegrationConfiguration;
import me.glindholm.mylyn.bamboo.internal.bamboo.model.BranchMonitoringConfiguration;
import me.glindholm.mylyn.bamboo.internal.bamboo.model.BranchSpecificConfiguration;
import me.glindholm.mylyn.bamboo.internal.bamboo.model.DockerPipelineConfiguration;
...
public class BuildDefinition implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(triggerDefinitions, dockerPipelineConfiguration, customConfiguration, branchSpecificConfiguration, taskDefinitions, configObjects, merged, branchMonitoringConfiguration, branchIntegrationConfiguration, cleanWorkingDirectory, repositoryIdDefiningWorkingDir);
  }
